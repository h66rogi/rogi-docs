...
[docs.rogi.chat](https://docs.rogi.chat)의 Docusaurus 소스입니다. HTTP 계약은 [OpenAPI 3.1 명세](static/openapi.yaml)에, WebSocket 이벤트와 재접속 방법은 [실시간 채팅 문서](docs/chat-stream.mdx)에 있습니다. 구현은 [rogi-collector](https://github.com/h66rogi/rogi-collector)의 Go `query/publicapi` 패키지를 따릅니다.
